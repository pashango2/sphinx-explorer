...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_interpreter = QtWidgets.QLabel(self.tab)
        self.label_interpreter.setText("")
        self.label_interpreter.setObjectName("label_interpreter")
        self.project_info_form_layout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.label_interpreter)
